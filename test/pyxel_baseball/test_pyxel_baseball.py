...
from pyxel_baseball.main import (  # pylint: disable=C0413
    IView,
    GameCore,
    Action,
    IInput,
...
class TestParent(unittest.TestCase):
    def setUp(self):
        ...
        self.patcher_view = patch(
            "pyxel_baseball.main.PyxelView.create", return_value=self.test_view
        )
        self.mock_view = self.patcher_view.start()
        self.test_input = TestInput()
        self.patcher_input = patch(
            "pyxel_baseball.main.PyxelInput.create", return_value=self.test_input
        )
