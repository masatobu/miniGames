...
class TestParent(unittest.TestCase):
    def setUp(self):
        ...
        self.patcher_view = patch(
            "pyxel_convert_send.framework.PyxelView.create", return_value=self.test_view
        )
        self.mock_view = self.patcher_view.start()
        self.test_input = TestInput()
        self.patcher_input = patch(
            "pyxel_convert_send.framework.PyxelInput.create",
...
class TestFieldParent(TestParent):
    def setUp(self):
        ...
        self.patcher_view = patch(
            "pyxel_convert_send.framework.PyxelFieldView.create",
