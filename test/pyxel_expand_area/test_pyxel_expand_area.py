...
from pyxel_expand_area.map_generator import IMapGenerator  # pylint: disable=C0413
...
class TestParent(unittest.TestCase):
    def setUp(self):
        ...
        self.patcher_view = patch(
            "pyxel_expand_area.main.PyxelView.create", return_value=self.test_view
        )
        self.mock_view = self.patcher_view.start()
        self.test_input = TestInput()
        self.patcher_input = patch(
            "pyxel_expand_area.main.PyxelInput.create", return_value=self.test_input
        )
...
class TestUnitParent(TestParent):
    def setUp(self):
        ...
        self.patcher_unit_view = patch(
            "pyxel_expand_area.main.PyxelUnitView.create",
        ...
        self.patcher_map_generator = patch(
            "pyxel_expand_area.main.AreaBlockAlgorithmGenerator.create",
